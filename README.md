...
3. Apart from that, in order to have usable tree in the browser, you need to add **o-ngx-tree styles** which you can find in your `node_modules/o-ngx-tree/styles.css`
